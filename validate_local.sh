#!/bin/bash
agents=(SENTINEL BOLT ATLAS BUDDHA HUNTER PICASSO SHTEF DOCKER KUBERNETES DATABASE CICD MONITORING API MOBILE TESTING WEB3 AIML IOT QUANTUM DOCS PYTHON JULES)
